...
public class Window_1 extends JFrame {
	...
	public Window_1() {
		...
		display1.setBounds(0, 31, 376, 217);
		contentPane.add(display1);
		
		text1 = new JTextArea();
		text1.setBounds(0, 278, 261, 43);
		...
		send1.setBounds(271, 279, 95, 42);
		contentPane.add(send1);
		
		JLabel label1 = new JLabel("Chat Window for " + username1);
		label1.setBounds(0, 0, 277, 30);
